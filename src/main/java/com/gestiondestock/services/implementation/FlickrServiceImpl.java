...
import com.gestiondestock.config.FlickrConfiguration;
...
public class FlickrServiceImpl implements FlickrService {
  ...
  private FlickrConfiguration flickrConfiguration;

  @Autowired
  public FlickrServiceImpl(FlickrConfiguration flickrConfiguration) {
    this.flickrConfiguration = flickrConfiguration;
  }
