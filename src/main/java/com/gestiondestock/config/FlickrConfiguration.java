...
public class FlickrConfiguration {
  ...
  /*
  @Bean //pour que cette mthode soit executer lorsque l'application est charge
  public Flickr getFlickr() throws InterruptedException, ExecutionException, IOException, FlickrException {
    ...
    OAuth10aService service = new ServiceBuilder(apiKey).apiSecret(apiSecret).build(FlickrApi.instance(FlickrPerm.DELETE));
  ...
  public Flickr getFlickr2() {
    ...
    flickr.setAuth(auth);
    System.out.println("connected to FLickr");
    return flickr;
  }
